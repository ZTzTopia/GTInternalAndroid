...
namespace utilities {
    namespace crash_dump {
        ...
        void crash_report(ucontext* context, siginfo_t *info, const char* type_name) {
            ...
            LOGE("backtrace:");
            LOGE("pc: 0x%X (libgrowtopia: 0x%X)", context->uc_mcontext.arm_pc, context->uc_mcontext.arm_pc - (uintptr_t)g_growtopia_map.startAddr);
            LOGE("lr: 0x%X (libgrowtopia: 0x%X)", context->uc_mcontext.arm_lr, context->uc_mcontext.arm_lr - (uintptr_t)g_growtopia_map.startAddr);
            ...
            LOGE("backtrace:");
            LOGE("pc: 0x%X (libgrowtopia: 0x%X)", context->uc_mcontext.pc, context->uc_mcontext.pc - (uintptr_t)g_growtopia_map.startAddr);
            LOGE("lr: 0x%X (libgrowtopia: 0x%X)", context->uc_mcontext.regs[14], context->uc_mcontext.regs[14] - (uintptr_t)g_growtopia_map.startAddr);
