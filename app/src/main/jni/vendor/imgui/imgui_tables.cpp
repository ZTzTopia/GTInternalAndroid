...
void    ImGui::EndTable()
{
    ...
    // We have no way to prevent user submitting direct ImDrawList calls into a hidden column (but Gui:: calls will be clipped out)
...
//   Direct ImDrawList calls won't be taken into account by default, if you use them make sure the Gui:: bounds
...
void Gui::DebugNodeTable(ImGuiTable*) {}
void Gui::DebugNodeTableSettings(ImGuiTableSettings*) {}
